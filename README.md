...
This chart deploys SABnzbd using the shared dependency `lib-chart` (`0.0.14`).

## Installation

```bash
helm install sabnzbd . --namespace download-clients
```
...
- `tests/sabnzbd_contract_test.yaml`
...
- Main container runs as UID/GID `1010/1010`
- Config PVC claim: `sabnzbd-config` (RWO)
